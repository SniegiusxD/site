...
const TABLES = ['user_settings', 'subscription', 'bankroll_entry', 'user_bet', 'bet_edit', 'book_limit_event', 'telegram_account', 'telegram_preset', 'telegram_sent', 'telegram_link_token', 'billing_event', 'execution_event', 'session', 'account']
